# -*- coding: utf-8 -*-
"""
Created on Fri Jan 17 15:02:42 2025
...
x_CNT1 = df['displacement (mm)'][0:11]
x_CNT1p5 = df['displacement (mm)'][15:26]
...
# Configurar los ejes
ax.set_xlabel('strain [-]', fontname="Times New Roman", color='k', fontsize=text_size)
